...
```sh
git clone https://github.com/nickjj/docker-rails-example aquafon_games
cd aquafon_games
...
The app is named `aquafon_games` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "aquafon_games" and update a few Docker related resources.
