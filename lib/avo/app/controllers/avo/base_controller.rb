...
module Avo
  class BaseController < ApplicationController
    ...
    def set_index_params
      ...
      if @index_params[:per_page].to_i > Avo.configuration.per_page_steps.max
        @index_params[:per_page] = Avo.configuration.per_page_steps.max
        cookies[:per_page] = Avo.configuration.per_page_steps.max
      end
